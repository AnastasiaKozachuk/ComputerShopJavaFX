...
public class GoodByDeliveryDiscController {
    ...
    void initialize() {
        ...
        findButton.setOnAction(event -> {
            ...
            String deliv_disc = delDiscList.getSelectionModel().getSelectedItem().toString();
            FXMLLoader loader = new FXMLLoader();
            if(!deliv_disc.isEmpty()){

                Boolean discount = null;

                if (deliv_disc.equals("Так")) {
                    discount = true;
                } else if (deliv_disc.equals("Hi")) {
                    discount = false;
                }


                GoodService goodService = new GoodServiceImpl();
                List<Good> goodList = goodService.getGoodByDeliveryDisc(discount);
    ...
    private void init() {
        delDiscList.getItems().add("Так");
        delDiscList.getItems().add("Hi");
        delDiscList.getSelectionModel().selectFirst();
    }
